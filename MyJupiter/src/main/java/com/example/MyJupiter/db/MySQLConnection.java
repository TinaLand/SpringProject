package com.example.MyJupiter.db;

import com.example.MyJupiter.entity.Item;
import com.example.MyJupiter.entity.ItemType;
...
//        }
//
//        // if could login, then user no need to be checked
//        //saveUser();
...
//        saveItem(item);
////        String sql = "INSERT INTO favorite_records (user_id, item_id) VALUES (userId, itemId)";
//
